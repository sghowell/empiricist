...
termination certificates (`termination`) and rule soundness against the semantic oracle
(`soundness`), behind certified pack verifiers (`verifiers`): `zx_derivation`,
`zx_semantic_equal`, `zx_critical_pairs`, `zx_termination`, `zx_rule_sound`. No optional
dependencies: the pack loads wherever core does.
"""
